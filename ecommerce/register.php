			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'Kyleraidendecastro368@gmail.com';     
				        $mail->Password = 'Lessthanzero';                    
				        ...
				        $mail->setFrom('Kyleraidendecastro368@gmail.com');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('Kyleraidendecastro368@gmail.com');
